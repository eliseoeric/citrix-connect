...
abstract class Admin_Menu {
	...
	public function admin_page_display() {
		$html = "<div class='wrap cmb2-options-page " . $this->key . "'>";
			$html .= "<h2>" . esc_html( get_admin_page_title() ) . "</h2>";
			$html .= cmb2_metabox_form( $this->metabox_id, $this->key );
		$html .= "</div>" ;
	...
	public function setting_notices( $object_id, $updated ) {
		if( $object_id !== $this->key || empty( $updated ) ) {
			return;
		}

		add_setting_error( $this->key . '-notices', '', __( 'Settings updated.', 'textdomain' ), 'updated' );
		settings_error( $this->key . '-notices' );
	}
