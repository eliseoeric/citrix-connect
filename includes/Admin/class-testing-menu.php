...
class Testing_Menu extends Admin_Menu {



	public function __construct() {
		$this->key = 'admin_config_sub_test';
		$this->parentKey = 'admin_config';
		$this->metabox_id = 'admin_config_sub_metabox';
		$this->prefix = '_ac_';
		$this->title = __( 'Admin sub Configure', 'textdomain' );
	}
