...
function register_courses() {
    ...
    register_post_type( 'citrix_training', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
        ...
        array ( 'labels'              => array (
            ...
            'singular_name'      => __( 'Course', 'citirx-connect' ), /* This is the individual type */
            'all_items'          => __( 'All Courses', 'citirx-connect' ), /* the all items menu item */
            'add_new'            => __( 'Add New', 'citirx-connect' ), /* The add new menu item */
            'add_new_item'       => __( 'Add New Course', 'citirx-connect' ), /* Add New Display Title */
            'edit'               => __( 'Edit', 'citirx-connect' ), /* Edit Dialog */
            'edit_item'          => __( 'Edit Course', 'citirx-connect' ), /* Edit Display Title */
            'new_item'           => __( 'New Course', 'citirx-connect' ), /* New Display Title */
            'view_item'          => __( 'View Course', 'citirx-connect' ), /* View Display Title */
            'search_items'       => __( 'Search Courses', 'citirx-connect' ), /* Search Custom Type Title */
            ...
            'parent_item_colon'  => ''
                ...
                'description'         => __( 'Post type that corresponds to the Citrix GoToTraining Entity', 'citirx-connect' ), /* Custom Type Description */
                'public'              => true,
               ...
               'rewrite'             => array ( 'slug' => 'training-courses', 'with_front' => false ), /* you can specify its url slug */
                'has_archive'         => 'training-courses', /* you can rename the slug here */
